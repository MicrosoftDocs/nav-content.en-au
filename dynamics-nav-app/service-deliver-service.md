...
|Post service orders for services, so that your accounting is up-to-date.|[How to: Post Service Orders and CR/Adj Notes](service-how-to-post-service-orders.md)|  
|Create and post invoices for services that you have delivered.|[How to: Create Service Invoices or CR/Adj Notes](service-how-create-invoices.md)|  
