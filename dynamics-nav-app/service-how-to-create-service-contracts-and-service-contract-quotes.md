...
## <a name="to-create-contract-service-credit-memos"></a>To create contract service CR/Adj Notes
...
1. Choose the ![Search for Page or Report](media/ui-search/search_small.png "Search for Page or Report icon") icon, enter **Service CR/Adj Notes**, and then choose the related link.  
2. Create a new service CR/Adj Note.  
3. Fill in the **No.** field.  
4. In the **Customer No.** field, enter the number of the customer in the service contract.  
  
     The **Invoicing** FastTab shows information copied from the **Customer** card. If you want to post the CR/Adj Note to a different customer than the one specified on the **General** FastTab, enter the number of that customer in the **Bill-to Customer No.** field.  
  
    > [!NOTE]  
    >  You can compare the CR/Adj Note to the original posted document in the **Posted Service Invoices** window. Choose the ![Search for Page or Report](media/ui-search/search_small.png "Search for Page or Report icon") icon, enter **Posted Service Invoices**, and then choose the related link.  
  
5. Fill in the **Posting Date** and **Document Date** fields.  
6. On the CR/adj note lines, enter information about the items that have been returned or removed, or the allowance that will be sent. You can also use the **Get Prepaid Contract Entries** batch job.  
...
>   
>  If the contract is detailed and prepaid, and you have posted invoices for the contract, you can create a CR/Adj Note for the contract. On the **Actions** tab, in the **Functions** group, choose **Create CR/Adj Note**. This is unnecessary if the check box in the **Automatic CR/Adj Notes** field on the **Invoice Details** FastTab is selected. In that case, a CR/Adj Note is created automatically when you remove a contract line. 
...
6. If there are unposted invoices, CR/Adj Notes, or opened prepaid entries for the contract, a confirmation message will appear. In the message box, choose **No** to return to the contract and post the documents, or **Yes** to continue the cancellation process.  
