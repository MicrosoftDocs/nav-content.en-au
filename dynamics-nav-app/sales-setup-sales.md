...
|Use an EU web service to verify a customer's Exemption Certification number.|[How to: Verify VAT Registration Numbers](sales-how-to-verify-vat-registration-numbers.md)|
