...
|Issue an additional prepayment invoice, either for additional items or for an additional deposit on the original order, or issue a prepayment CR/adj note.|[How to: Correct Prepayments](finance-how-to-correct-prepayments.md)|  
