...
---
# <a name="how-to-post-service-orders-and-credit-memos"></a>How to: Post Service Orders and CR/Adj Notes
...
## <a name="to-post-a-service-credit-memo"></a>To post a service CR/Adj Note  
When you have created a service CR/Adj Note and filled it in, you can post the CR/Adj Note. If there are errors or a lack of information on the CR/Adj Note while posting, the process will be interrupted by an error message.  
...
2. Create a new service CR/Adj Note. On the **Home** tab, in the **New** group, choose **New**.  
3. Fill in the necessary fields.  
4. On the **Actions** tab, in the **Posting** group, choose **Post**. If you want to print the CR/Adj Note at the same time as you post, choose **Post and Print** instead.  
5. To test CR/Adj Notes before you post them, choose **Test Report**. When you run the report, the posting dates specified in the document are verified.  
6. To post several service CR/Adj Notes at the same time. run the **Batch Post Service CR/Adj Notes** batch job. This can be an advantage if you have a large number of CR/adj note that must be posted.  
  
> [!NOTE]  
>  It is important to enter all the necessary information on the CR/adj notes before they are batch posted. Otherwise, it is possible that they will not be posted. When the batch job has finished posting, a message is displayed that shows how many of the service CR/Adj Notes have been posted.  
