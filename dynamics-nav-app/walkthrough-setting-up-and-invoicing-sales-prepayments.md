...
3.  Verify that the number series for posted prepayment invoices in the **Posted Prepmt. Inv. Nos.** field is the same as for posted sales invoices (**Posted Invoice Nos.**) and the number series for posted prepayment CR/Adj Notes (**Posted Prepmt. CR/Adj Note Nos.**) is the same as for posted CR/Adj Notes (**Posted CR/Adj Note Nos.**).  
...
10. Change the amount in the **Prepmt. Line Amount Excl. GST** field to **2000** and then close the window.  
