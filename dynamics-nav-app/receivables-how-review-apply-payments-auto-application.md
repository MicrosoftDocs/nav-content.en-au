...
**Note**: You cannot apply entries with a different sign than the sign on the payment. For example, to close both a negative-sign CR/Adj note and its related positive-sign invoice, you must first apply the CR/Adj note to the invoice, and then apply the payment to the invoice with the reduced remaining amount.
