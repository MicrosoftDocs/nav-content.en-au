...
---
# <a name="how-to-create-service-invoices-or-credit-memos"></a>How to: Create Service Invoices or CR/Adj Notes
...
## <a name="to-create-a-service-credit-memo"></a>To create a service CR/Adj Note  
